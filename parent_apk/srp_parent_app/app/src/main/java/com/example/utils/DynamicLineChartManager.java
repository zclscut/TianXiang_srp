...
public class DynamicLineChartManager {
     ...
     * @param number
     */
    public void addEntry(int number,int maxShowNumberCount) {
        ...
        //设置在曲线图中显示的最大数量
        lineChart.setVisibleXRangeMaximum(maxShowNumberCount);
        //移到某个位置
     ...
     * @param numbers
     */
    public void addEntry(List<Integer> numbers,int maxShowNumberCount) {
        ...
        for (int i = 0; i < numbers.size(); i++) {
            ...
            lineData.notifyDataChanged();
            lineChart.notifyDataSetChanged();
            lineChart.setVisibleXRangeMaximum(maxShowNumberCount);//设置x轴最大显示数量
            lineChart.moveViewToX(lineData.getEntryCount() - 5);
        }
    }
